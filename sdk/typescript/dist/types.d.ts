...
export type NodeKind = 'File' | 'Module' | 'Function' | 'Class' | 'Method' | 'Interface' | 'Enum' | 'Variable' | 'Field' | 'Parameter' | 'TypeAlias' | 'Import' | 'Macro' | 'Anonymous' | 'Block';
...
export type EdgeKind = 'Contains' | 'Calls' | 'References' | 'Defines' | 'Inherits' | 'Implements' | 'Overrides' | 'Imports' | 'Exports' | 'DependsOn' | 'Declares' | 'Next';
